...
-------------------------------------------------- */
	...
	function initCountNbr () {
		...
		var countValue1 = $('#counter1').val();
		var countValue2 = parseInt($('#counter2').val());
		var countValue3 = parseInt($('#counter3').val());
		...
		if (hasCounters) {
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-1', 0, countValue1, 0, 3, options);
					counter1.start();
					// Counter 2
					var counter2 = new CountUp('count-2', 0, countValue2, 0, 3, options);
					counter2.start();
					// Counter 3
					var counter3 = new CountUp('count-3', 0, countValue3, 0, 3, options);
					counter3.start();
					// init only once
					this.destroy();
				},
